# SENTINELA Security Assessment Report
...
SENTINELA conducted a full-scope automated security assessment against `example.com` and its associated infrastructure. The scan identified **3 critical**, **4 high**, **4 medium**, and **3 low** severity findings.
...
> These are compound risks automatically detected by SENTINELA's intelligence engine.
...
> Generated by SENTINELA intelligence engine based on scan findings.
...
*Report generated by SENTINELA v3.0 — For authorized security testing only.*
