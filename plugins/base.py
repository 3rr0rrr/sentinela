...
class SentinelaPlugin:
    """
    Base class for all SENTINELA plugins.
...
class PluginLoader:
    ...
    def __init__(self, plugin_dir: str = None):
        ...
        self._plugins:    List[SentinelaPlugin] = []
    ...
    def load_all(self,
                 ...
                 completed_phases: list = None) -> List[SentinelaPlugin]:
        """
    ...
    def _run_sandboxed(self, plugin: SentinelaPlugin,
    ...
    def _load_file(self, py_file: Path) -> List[SentinelaPlugin]:
        ...
        return [
            ...
            if (isinstance(getattr(module, name), type) and
                issubclass(getattr(module, name), SentinelaPlugin) and
                getattr(module, name) is not SentinelaPlugin)
        ]
    ...
    @property
    def loaded(self)  -> List[SentinelaPlugin]: return self._plugins
    @property
